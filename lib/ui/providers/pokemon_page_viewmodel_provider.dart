...
import 'package:pokedex_3d/ui/viewmodel/pokemon_view_page_viewmodel.dart';

final pokemonPageViewmodelProvider =
    StateNotifierProvider<PokemonDetailPageViewModel, PokemonDetailPageState>((
      ref,
    ) {
      final controller = PokemonDetailPageViewModel(
