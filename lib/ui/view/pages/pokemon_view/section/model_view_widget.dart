...
import 'package:pokedex_3d/core/utils/snackbar_manager.dart';
...
import 'package:pokedex_3d/ui/view/pages/pokemon_view/section/pokemon_details_tab.dart';
import 'package:pokedex_3d/ui/view/pages/pokemon_view/widgets/pokemon_title_widget.dart';
import 'package:pokedex_3d/ui/view/pages/pokemon_view/widgets/toggle_animation_widget.dart';
import 'package:pokedex_3d/ui/view/pages/pokemon_view/widgets/fullscreen_toggle_button.dart';
...
class _ModelViewWidgetState extends ConsumerState<ModelViewWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    ref.listen(pokemonPageViewmodelProvider.select((s) => s.modelPath), (
      ...
      next.maybeWhen(
        error: (e, st) {
          SnackBarManager.showError(context, e.toString());
        },
        data: (data) {
      ...
      builder: (context, constrints) {
        ...
        return Stack(
          children: [
            ...
            Positioned(right: 15, top: 0, child: PokemonIdWidget()),
            const Positioned(
              top: 0,
              left: 0,
